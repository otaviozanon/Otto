...
export default function HomePage() {
  ...
  }, [name, setError, t.home.errorName]);
  ...
  }, [name, roomCode, setError, t.home.errorName, t.home.errorCode]);
      ...
      <div className="w-full max-w-md space-y-10 animate-fade-in">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-5 rounded-2xl bg-gradient-to-r from-brand to-amber-600 hover:from-amber-400 hover:to-amber-700 active:scale-[0.98] text-white font-black text-lg transition-all duration-200 touch-target shadow-2xl shadow-brand/30"
          >
            <Users size={22} />
            {t.home.createRoom}
            <ArrowRight size={18} />
